...
import { ReactNode, useContext, createContext, Context } from "react"
...
type appThemeType = { themeColor: string, roboto: NextFont, ubuntu: NextFont, comicNeue: NextFont, poppins: NextFont, lato: NextFont, pacifico: NextFont }
